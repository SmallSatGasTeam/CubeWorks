...
class EPS(Driver):
    ...
    def getSPXVoltage(self):
        return 21 * 0.0024414063 #Reads data of specified type, sets up conversion factor to V

    def getSPXMinusCurrent(self):
        return 22 * 0.0006103516 #Reads data of specified type, sets up conversion factor to A
    ...
    def getSPYVoltage(self):
        return 24 * 0.0024414063 #Reads data of specified type, sets up conversion factor to V

    def getSPYMinusCurrent(self):
        return 25 * 0.0006103516 #Reads data of specified type, sets up conversion factor to A

    def getSPYPlusCurrent(self):
        return 26 * 0.0006103516 #Reads data of specified type, sets up conversion factor to A

    def getSPZVoltage(self):
        return 27 * 0.0024414063 #Reads data of specified type, sets up conversion factor to V

    def getSPZPlusVoltage(self):
        return 28 * 0.0006103516
