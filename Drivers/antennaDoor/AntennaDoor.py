...
class AntennaDoor(Driver):
    ...
    def __init__(self):
        ...
        self.__DEVICE_BUS = 1
        self.__DEVICE_ADDR = 0x33
        self.__RegisterADR = 0x00 # I do not know what this means or what it should be
        self.__bus = smbus.SMBus(DEVICE_BUS)
      
    def readDoorStatus():
      #returns the status of all 4 antenna doors
      doorStatus = bus.read_i2c_block_data(self.__DEVICE_ADDR, self.__RegisterADR, 1)
      return doorStatus
