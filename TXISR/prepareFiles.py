...
def prepareData(duration, dataType, startFromBeginning):
	if (dataType == 0): #Attitude Data
		...
		fileChecker.checkFile('../../flightLogicData/Attitude_Data.txt')
		dataFilePath = ('../../flightLogicData/Attitude_Data.txt') #Set data file path to respective file
		...
		fileChecker.checkFile('../../flightLogicData/TTNC_Data.txt')
		dataFilePath = ('../../flightLogicData/TTNC_Data.txt') #Set data file path to respective file		
		print("TTNC Data selected")
	else: #Deploy Data
		packetLength = 25 + 14 #Packet length in bytes plus the 7 GASPACS bytes on each end
		fileChecker.checkFile('../../flightLogicData/Deploy_Data.txt')
		dataFilePath = ('../../flightLogicData/Deploy_Data.txt') #Set data file path to respective file		
	...
	progressFilePath = ('../../TXISRData/flagsFile.txt') #File Path to Shawn's flag file, which stores transmission progress
	fileChecker.checkFile(transmissionFilePath)	
