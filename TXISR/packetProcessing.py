...
def writeTXWindow(windowStart, windowDuration, dataType, pictureNumber, startFromBeginning):
	...
	fileChecker.checkFile("../../TXISRData/txWindows.txt")
	TXWindow_File = open("../../TXISRData/txWindows.txt", "a+")
...
def disableTransmissions():
	...
	fileChecker.checkFile("../../TXISRData/transmissionFlag.txt")
	transmissionFlag_File = open("../../TXISRData/transmissionFlag.txt", "w")
...
def disableAX25():
	fileChecker.checkFile("../../TXISRData/AX25Flag.txt")
	# This function will set a flag that will disable the radio transmissions. We will check the flag before making any transmissions.
	AX25Flag_File = open("../../TXISRData/AX25Flag.txt", "w")
...
def clearTXFile():
	...
	transmissionFlag_File = open("../../TXISRData/txWindows.txt", "w")
	
	# close file
	transmissionFlag_File.close()
	
def clearTXProgress():
	fileChecker.checkFile("../../TXISRData/flagsFile.txt")
